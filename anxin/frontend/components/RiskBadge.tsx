 ...
 */
const RISK_CONFIG: Record<RiskBand, { icon: IconName; bg: string; fg: string; labelKey: ResultsStringKey }> = {
  low: { icon: "check", bg: "bg-anxin-risk-low-bg", fg: "text-anxin-risk-low", labelKey: "riskLow" },
  medium: { icon: "warning", bg: "bg-anxin-risk-medium-bg", fg: "text-anxin-risk-medium", labelKey: "riskMedium" },
  high: { icon: "cross", bg: "bg-anxin-risk-high-bg", fg: "text-anxin-risk-high", labelKey: "riskHigh" },
};
